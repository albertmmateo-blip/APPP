...
import com.appp.avisos.databinding.ActivityFacturesSubcategoryDetailBinding
import com.appp.avisos.viewmodel.MainViewModel

/**
 * Activity that displays notes for a specific Factures subcategory.
 * Opened when Pedro taps on a subcategory button.
 */
class FacturesSubcategoryDetailActivity : AppCompatActivity() {
    
    private lateinit var binding: ActivityFacturesSubcategoryDetailBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityFacturesSubcategoryDetailBinding.inflate(layoutInflater)
        ...
        supportActionBar?.title = subcategory ?: "Factures"
    ...
    private fun setupRecyclerView() {
        ...
        binding.recyclerViewNotes.apply {
            layoutManager = LinearLayoutManager(this@FacturesSubcategoryDetailActivity)
    ...
    private fun observeNotes() {
        subcategory?.let { sub ->
            viewModel.getNotesByCategoryAndSubcategory("Factures", sub).observe(this) { notes ->
    ...
    private fun openNoteDetail(note: Note) {
        val intent = Intent(this, NoteDetailActivity::class.java).apply {
            ...
            putExtra(NoteDetailActivity.EXTRA_CURRENT_CATEGORY, "Factures|$subcategory")
        }
    ...
    private fun openNoteEditor(note: Note?) {
        ...
        intent.putExtra(NoteEditorActivity.EXTRA_CURRENT_CATEGORY, "Factures|$subcategory")
